    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="projects" className={`${this.props.article === 'projects' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          how would this feel if I were to use it everyday at work.
          this keyboard is fairly respnsive.
          but I feel like I have to press the keys too hard
          or that it feels like I have to press down a lot more.
          I'm not sure. meep. meep. meep
          how do I like this keyboard, I'm not really sure. But I'm using it all right.
          bleah blah blah blah.
